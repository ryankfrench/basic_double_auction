...
class StaffSessionParametersView(SingleObjectMixin, View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        parameterset_player_type_form_ids=[]
        for i in parameterset_player_type_form:
            parameterset_player_type_form_ids.append(i.html_name)
        ...
        return render(request=request,
                      ...
                      context={"channel_key" : uuid.uuid4(),
                               ...
                               "parameter_set_player_type_form" : parameterset_player_type_form,
                               "parameterset_form_ids" : parameterset_form_ids,
                               "parameterset_player_form_ids" : parameterset_player_form_ids,
                               "parameterset_player_type_form_ids" : parameterset_player_type_form_ids,
